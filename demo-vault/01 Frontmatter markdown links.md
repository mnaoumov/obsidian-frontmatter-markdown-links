...
- `markdownLink` - `[Second target](<Targets/Second target.md>)`. **This is what the plugin adds.** Without it, the value is plain text; with it, it is a link you can click to open [Second target](<./Targets/Second target.md>).
